replaceitem entity @s slot.hotbar 0 coldsink:tone_weapon 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 1 coldsink:tone_melee 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 2 coldsink:tone_skill_0 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
replaceitem entity @s slot.hotbar 6 coldsink:tone_skill_3 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 7 coldsink:tone_skill_2 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 8 coldsink:tone_skill_1 1 0 {"item_lock":{"mode":"lock_in_slot"}}
