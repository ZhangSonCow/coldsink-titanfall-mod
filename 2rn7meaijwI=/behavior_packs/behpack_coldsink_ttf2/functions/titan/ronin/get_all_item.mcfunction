replaceitem entity @s slot.hotbar 0 coldsink:ronin_weapon 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 1 coldsink:ronin_melee 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 2 coldsink:ronin_skill_0 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
replaceitem entity @s slot.hotbar 6 coldsink:ronin_skill_3 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 7 coldsink:ronin_skill_2 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 8 coldsink:ronin_skill_1 1 0 {"item_lock":{"mode":"lock_in_slot"}}
