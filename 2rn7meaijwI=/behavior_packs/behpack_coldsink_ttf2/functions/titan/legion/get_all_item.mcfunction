replaceitem entity @s slot.hotbar 0 coldsink:legion_weapon 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 1 coldsink:legion_melee 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 2 coldsink:legion_skill_0 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
replaceitem entity @s slot.hotbar 6 coldsink:legion_skill_3 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 7 coldsink:legion_skill_2 1 0 {"item_lock":{"mode":"lock_in_slot"}}
replaceitem entity @s slot.hotbar 8 coldsink:legion_skill_1 1 0 {"item_lock":{"mode":"lock_in_slot"}}
