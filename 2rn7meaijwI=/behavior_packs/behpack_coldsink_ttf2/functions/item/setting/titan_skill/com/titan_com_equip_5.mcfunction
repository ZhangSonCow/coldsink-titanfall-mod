...
scoreboard players set @s[tag=ion_choose,tag=is_choose] ion_equip_c 5
scoreboard players set @s[tag=tone_choose,tag=is_choose] tone_equip_c 5
scoreboard players set @s[tag=northstar_choose,tag=is_choose] northstar_equip_c 5
scoreboard players set @s[tag=ronin_choose,tag=is_choose] ronin_equip_c 5
scoreboard players set @s[tag=scorch_choose,tag=is_choose] scorch_equip_c 5
scoreboard players set @s[tag=legion_choose,tag=is_choose] legion_equip_c 5
scoreboard players set @s[tag=monarch_choose,tag=is_choose] monarch_equip_c 5
title @s[tag=is_choose] actionbar §f已选择 §c【核能弹射】
